...
like <code>3.8.2-<b>1</b></code>. When
published as a npm package, the version gets
a fifth number,
like <code>3.8.2-1.<b>1</b></code>.

Since adherence of third party packages to SemVer is not guaranteed,
it is recommended to avoid referring to the xPack GNU bison dependency via
a SemVer expressions
like <code>^3.8.2-1</code> or <code>~3.8.2-1</code>, and
