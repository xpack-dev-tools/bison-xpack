...
`% ~/Library/xPacks/${props.shortName}/xpack-${props.shortName}-3.8.2-1/bin/${props.programName} --version
...
<CodeBlock language="console"> {
`$ ~/.local/xPacks/${props.shortName}/xpack-${props.shortName}-3.8.2-1/bin/${props.programName} --version
${props.branding}3.8.2
`} </CodeBlock>
