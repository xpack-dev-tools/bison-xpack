...
`% ~/Library/xPacks/@xpack-dev-tools/${props.shortName}/3.8.2-1.1/.content/bin/${props.programName} --version
...
<CodeBlock language="console"> {
`$ ~/.local/xPacks/@xpack-dev-tools/${props.shortName}/3.8.2-1.1/.content/bin/${props.programName} --version
${props.branding}3.8.2
`} </CodeBlock>
