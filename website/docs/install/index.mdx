...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/bison@${customField('releaseVersion')} --verbose
`} </CodeBlock>
...
<ul>
<li><code>xpack-bison-{customField('xpackVersion')}-darwin-x64.tar.gz</code></li>
<li><code>xpack-bison-{customField('xpackVersion')}-darwin-arm64.tar.gz</code></li>
</ul>
...
<ul>
<li><code>xpack-bison-{customField('xpackVersion')}-linux-x64.tar.gz</code></li>
<li><code>xpack-bison-{customField('xpackVersion')}-linux-arm64.tar.gz</code></li>
<li><code>xpack-bison-{customField('xpackVersion')}-linux-arm.tar.gz</code></li>
</ul>
