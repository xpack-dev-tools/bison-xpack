...
title: Getting Started with xPack GNU bison
...
![GitHub Repo stars](https://img.shields.io/github/stars/xpack-dev-tools/bison-xpack)

## Overview

**xPack GNU bison** is a standalone
cross-platform (GNU/Linux, macOS)binary distribution of GNU bison,
...
The details of installing the **xPack GNU bison** on various platforms are
presented in the
...
[GitHub Discussions](https://github.com/xpack-dev-tools/bison-xpack/discussions/).
...
[`CHANGELOG.md`](https://github.com/xpack-dev-tools/bison-xpack/blob/xpack/CHANGELOG.md) file.
...
[`bison-xpack.git/build-assets/scripts`](https://github.com/xpack-dev-tools/bison-xpack/tree/xpack/build-assets/scripts/)
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/bison-xpack/): It helps others discover our work.
