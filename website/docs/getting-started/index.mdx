...
**xPack GNU bison** is a standalone cross-platform (Windows, macOS, GNU/Linux)
binary distribution of GNU bison,
intended for reproducible builds.

<Overview/>

**xPack GNU bison** is an open source project hosted on GitHub as
...
[build scripts](https://github.com/xpack-dev-tools/bison-xpack/tree/xpack/scripts).
...
[`bison-xpack.git/scripts`](https://github.com/xpack-dev-tools/bison-xpack/tree/xpack/scripts/)
