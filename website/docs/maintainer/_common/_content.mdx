...
```sh
npm run generate-top-commons -C ~/Work/xpack-dev-tools/bison-xpack.git
```
...
- switch to https://xpack-dev-tools.github.io/bison-xpack/docs/maintainer/#update-the-xpack-branch
