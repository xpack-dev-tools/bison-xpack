...
**@xpack-dev-tools/bison** is an xpm package that packages platform-specific archives, built with the [xPack Build Box (XBB)](https://xpack.github.io/xpack-build-box/).
...
```sh
rm -rf ~/Work/xpack-dev-tools/bison-xpack.git/package-lock.json
```

```sh
rm -rf ~/Work/xpack-dev-tools/bison-xpack.git/build-assets/package-lock.json
git -C ~/Work/xpack-dev-tools/bison-xpack.git pull

npm --prefix ~/Work/xpack-dev-tools/bison-xpack.git/build-assets install
xpm install -C ~/Work/xpack-dev-tools/bison-xpack.git/build-assets
...
(such as **3.8.2-1.1**) with the following expression:
...
xpm run trigger-workflow-test-docker-linux-arm64 -C ~/Work/xpack-dev-tools/bison-xpack.git/build-assets
```
...
tagged such as **v3.8.2-1** (mind the dash in the middle!) and
named such as **xPack GNU bison v3.8.2-1** (mind the dash),
...
- Navigate to the [GitHub Releases](https://github.com/xpack-dev-tools/bison-xpack/releases) page
...
npm --prefix ~/Work/xpack-dev-tools/bison-xpack.git/build-assets install && \
xpm install -C ~/Work/xpack-dev-tools/bison-xpack.git/build-assets && \
xpm run test-release -C ~/Work/xpack-dev-tools/bison-xpack.git/build-assets
```
