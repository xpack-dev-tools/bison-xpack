...
xpm install --config ${props.platform} -C ~/Work/xpack-dev-tools/bison-xpack.git/build-assets && \\
xpm run build-development --config ${props.platform} -C ~/Work/xpack-dev-tools/bison-xpack.git/build-assets
`} </CodeBlock>
...
- <code>xpack-bison-3.8.2-1-{props.platform}.tar.gz</code>
- <code>xpack-bison-3.8.2-1-{props.platform}.tar.gz.sha</code>
...
xpm run deep-clean --config ${props.platform}  -C ~/Work/xpack-dev-tools/bison-xpack.git/build-assets && \\
xpm install --config ${props.platform} -C ~/Work/xpack-dev-tools/bison-xpack.git/build-assets && \\
xpm run build --config ${props.platform} -C ~/Work/xpack-dev-tools/bison-xpack.git/build-assets
`} </CodeBlock>
