...
const config: Config = {
  title: 'xPack GNU bison' +
    ((process.env.DOCUSAURUS_IS_PREVIEW === 'true') ? ' (preview)' : ''),
  tagline: 'A binary distribution of GNU bison',
  ...
  projectName: 'bison-xpack', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/xpack-dev-tools/bison-xpack/edit/xpack/website/',
        ...
        sitemap: {
          ...
          priority: 0.5,
          ignorePatterns: [
            '/bison-xpack/blog/archive/**',
            '/bison-xpack/blog/authors/**',
            '/bison-xpack/blog/tags/**'
          ],
  ...
  headTags: [
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/png',
        href: '/bison-xpack/favicons/favicon-48x48.png',
        sizes: '48x48'
      }
    },
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/svg+xml',
        href: '/bison-xpack/favicons/favicon.svg'
      }
    },
    {
      tagName: 'link',
      attributes: {
        rel: 'shortcut icon',
        href: '/bison-xpack/favicons/favicon.ico'
      }
    },
    {
    ...
    },
    {
      ...
      attributes: {
        rel: 'manifest',
        href: '/bison-xpack/favicons/site.webmanifest'
      }
    }
  ],
  ...
  themeConfig: {
    ...
    metadata: [
      {
        name: 'keywords',
        content: 'xpack, binary, development, tools, reproducibility, bison'
      }
    ],
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/xpack-dev-tools/bison-xpack/',
          position: 'right',
        ...
        },
        {
          ...
          position: 'right',
          href: `https://github.com/xpack-dev-tools/bison-xpack/releases/tag/v${customFields.xpackVersion}`,
        },
      ],
    },
    footer: {
      ...
      links: [
          ...
          items: [
            {
              ...
              href: 'https://github.com/xpack-dev-tools/bison-xpack/discussions',
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'GitHub bison-xpack project',
              href: 'https://github.com/xpack-dev-tools/bison-xpack/',
            },
            {
