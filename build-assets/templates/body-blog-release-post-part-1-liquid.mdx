---
title:  xPack GNU bison v{{releaseVersion}} released
...
bison_version: "{{upstreamVersion}}"
bison_date: "{{customFields.bisonReleaseDate}}"

version: "{{releaseVersion}}"
npm_subversion: "1"

download_url: https://github.com/xpack-dev-tools/bison-xpack/releases/tag/v{{releaseVersion}}/
...
The full details of installing the **xPack GNU bison**
on various platforms are presented in the [Install Guide](/docs/install/).

## Compliance

The **xPack GNU bison** is based on the official
[GNU bison](https://www.gnu.org/software/bison/) sources.
